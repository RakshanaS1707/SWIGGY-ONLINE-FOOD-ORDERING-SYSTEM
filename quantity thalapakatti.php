...
<script type="text/javascript" src="t quantity.js">  </script>
 </head>
...
<option value="Panner biriyani">Panner biriyani</option>
<option value="Chicken gravy">Chicken gravy</option> 
<option value="Mutton gravy">Mutton gravy</option> 
<option value="Mushroom kadai">Mushroom kadai</option> 
<option value="Panner butter masala">Panner butter masala</option> 
<option value="Egg curry">Egg curry</option> 
<option value="Califlower gravy">Califlower gravy</option> 
<option value="Vegetable kadai">Vegetable kadai</option>
<option value="Chilly chicken">Chilly chicken</option> 
<option value="Mutton chukka">Mutton chukka</option> 
<option value="Mushroom manjurian">Mushroom manjurian</option> 
<option value="Mushroom chilly">Mushroom chilly</option> 
<option value="Chicken manjurian">Chicken manjurian</option> 
<option value="Egg pepper fry">Egg pepper fry</option> 
