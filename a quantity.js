function createBill(){
    ...
    var e22 = document.getElementById("item22");
    itemselected22 = e22.options[e22.selectedIndex].value;
    if(itemselected22!="1"){
    items[index]=itemselected22;
    quantities[index] = document.getElementById("q22").value;
    prices[index] = document.getElementById("p22").value;
    index++;
    }
    var e23 = document.getElementById("item23");
    itemselected23 = e23.options[e23.selectedIndex].value;
    if(itemselected23!="1"){
    items[index]=itemselected23;
    quantities[index] = document.getElementById("q23").value;
    prices[index] = document.getElementById("p23").value;
    index++;
    }
    var e24 = document.getElementById("item24");
    itemselected24 = e24.options[e24.selectedIndex].value;
    if(itemselected24!="1"){
    items[index]=itemselected24;
    quantities[index] = document.getElementById("q24").value;
    prices[index] = document.getElementById("p24").value;
    index++;
    }
    var e25 = document.getElementById("item25");
    itemselected25 = e25.options[e25.selectedIndex].value;
    if(itemselected25!="1"){
    items[index]=itemselected25;
    quantities[index] = document.getElementById("q25").value;
    prices[index] = document.getElementById("p25").value;
    index++;
    }
    var e26 = document.getElementById("item26");
    itemselected26 = e26.options[e26.selectedIndex].value;
    if(itemselected26!="1"){
    items[index]=itemselected26;
    quantities[index] = document.getElementById("q26").value;
    prices[index] = document.getElementById("p26").value;
    index++;
    }
